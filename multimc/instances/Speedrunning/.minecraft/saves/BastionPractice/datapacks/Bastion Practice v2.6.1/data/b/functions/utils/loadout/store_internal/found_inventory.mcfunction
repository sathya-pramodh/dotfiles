...
execute store result storage inventory whole_inventory[-1].Slot byte 1 run scoreboard players remove #slot bastiongen 9

# Move item into the inventory section:
data modify storage inventory inventory append from storage inventory whole_inventory[-1]
