...
execute as @e[tag=blind_name] run data modify entity @s CustomNameVisible set value 1b
# Portal Times
...
execute as @e[tag=blind] run data modify entity @s CustomNameVisible set value 1b