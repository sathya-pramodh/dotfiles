...
execute store result score bool magma run data get storage magma formation[18]
# Swaps it from 0->1 and 1->0
function magma:ui/swap
# Stores result back into storage
execute store result storage magma formation[18] int 1 run scoreboard players get bool magma
