...
execute unless score editing Loadouts matches 1 run function end-practice:loadouts/3/apply
...
execute unless score editing Loadouts matches 1 run data merge block ~ ~ ~ {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function end-practice:loadouts/3/save_loadout"}}',Text2:'{"text":"Loadout 3","color":"white"}',Text3:'{"text":"Click to Save","color":"green"}'}
