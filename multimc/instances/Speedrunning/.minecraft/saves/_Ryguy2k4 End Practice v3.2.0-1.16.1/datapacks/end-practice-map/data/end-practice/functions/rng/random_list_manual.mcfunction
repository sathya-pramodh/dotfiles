...
execute store result score bool ChestMenu run data get storage minecraft:list_manual Items[0].tag.saved
...
execute store result score bool ChestMenu run data get storage minecraft:list_manual Items[1].tag.saved
execute if score bool ChestMenu matches 1 run scoreboard players add numListSlots CONSTANT 1
execute if score bool ChestMenu matches 1 run scoreboard players set bool ChestMenu 0
execute store result score bool ChestMenu run data get storage minecraft:list_manual Items[2].tag.saved
execute if score bool ChestMenu matches 1 run scoreboard players add numListSlots CONSTANT 1
execute if score bool ChestMenu matches 1 run scoreboard players set bool ChestMenu 0
execute store result score bool ChestMenu run data get storage minecraft:list_manual Items[3].tag.saved
execute if score bool ChestMenu matches 1 run scoreboard players add numListSlots CONSTANT 1
execute if score bool ChestMenu matches 1 run scoreboard players set bool ChestMenu 0
execute store result score bool ChestMenu run data get storage minecraft:list_manual Items[4].tag.saved
execute if score bool ChestMenu matches 1 run scoreboard players add numListSlots CONSTANT 1
execute if score bool ChestMenu matches 1 run scoreboard players set bool ChestMenu 0
execute store result score bool ChestMenu run data get storage minecraft:list_manual Items[5].tag.saved
execute if score bool ChestMenu matches 1 run scoreboard players add numListSlots CONSTANT 1
execute if score bool ChestMenu matches 1 run scoreboard players set bool ChestMenu 0
execute store result score bool ChestMenu run data get storage minecraft:list_manual Items[6].tag.saved
execute if score bool ChestMenu matches 1 run scoreboard players add numListSlots CONSTANT 1
execute if score bool ChestMenu matches 1 run scoreboard players set bool ChestMenu 0
execute store result score bool ChestMenu run data get storage minecraft:list_manual Items[7].tag.saved
execute if score bool ChestMenu matches 1 run scoreboard players add numListSlots CONSTANT 1
execute if score bool ChestMenu matches 1 run scoreboard players set bool ChestMenu 0
execute store result score bool ChestMenu run data get storage minecraft:list_manual Items[9].tag.saved
execute if score bool ChestMenu matches 1 run scoreboard players add numListSlots CONSTANT 1
execute if score bool ChestMenu matches 1 run scoreboard players set bool ChestMenu 0
execute store result score bool ChestMenu run data get storage minecraft:list_manual Items[10].tag.saved
execute if score bool ChestMenu matches 1 run scoreboard players add numListSlots CONSTANT 1
execute if score bool ChestMenu matches 1 run scoreboard players set bool ChestMenu 0
execute store result score bool ChestMenu run data get storage minecraft:list_manual Items[11].tag.saved
execute if score bool ChestMenu matches 1 run scoreboard players add numListSlots CONSTANT 1
execute if score bool ChestMenu matches 1 run scoreboard players set bool ChestMenu 0
execute store result score bool ChestMenu run data get storage minecraft:list_manual Items[12].tag.saved
execute if score bool ChestMenu matches 1 run scoreboard players add numListSlots CONSTANT 1
execute if score bool ChestMenu matches 1 run scoreboard players set bool ChestMenu 0
execute store result score bool ChestMenu run data get storage minecraft:list_manual Items[13].tag.saved
execute if score bool ChestMenu matches 1 run scoreboard players add numListSlots CONSTANT 1
execute if score bool ChestMenu matches 1 run scoreboard players set bool ChestMenu 0
execute store result score bool ChestMenu run data get storage minecraft:list_manual Items[14].tag.saved
execute if score bool ChestMenu matches 1 run scoreboard players add numListSlots CONSTANT 1
execute if score bool ChestMenu matches 1 run scoreboard players set bool ChestMenu 0
execute store result score bool ChestMenu run data get storage minecraft:list_manual Items[15].tag.saved
execute if score bool ChestMenu matches 1 run scoreboard players add numListSlots CONSTANT 1
execute if score bool ChestMenu matches 1 run scoreboard players set bool ChestMenu 0
execute store result score bool ChestMenu run data get storage minecraft:list_manual Items[16].tag.saved
execute if score bool ChestMenu matches 1 run scoreboard players add numListSlots CONSTANT 1
execute if score bool ChestMenu matches 1 run scoreboard players set bool ChestMenu 0
execute store result score bool ChestMenu run data get storage minecraft:list_manual Items[18].tag.saved
execute if score bool ChestMenu matches 1 run scoreboard players add numListSlots CONSTANT 1
execute if score bool ChestMenu matches 1 run scoreboard players set bool ChestMenu 0
execute store result score bool ChestMenu run data get storage minecraft:list_manual Items[19].tag.saved
execute if score bool ChestMenu matches 1 run scoreboard players add numListSlots CONSTANT 1
execute if score bool ChestMenu matches 1 run scoreboard players set bool ChestMenu 0
execute store result score bool ChestMenu run data get storage minecraft:list_manual Items[20].tag.saved
execute if score bool ChestMenu matches 1 run scoreboard players add numListSlots CONSTANT 1
execute if score bool ChestMenu matches 1 run scoreboard players set bool ChestMenu 0
execute store result score bool ChestMenu run data get storage minecraft:list_manual Items[21].tag.saved
execute if score bool ChestMenu matches 1 run scoreboard players add numListSlots CONSTANT 1
execute if score bool ChestMenu matches 1 run scoreboard players set bool ChestMenu 0
execute store result score bool ChestMenu run data get storage minecraft:list_manual Items[22].tag.saved
execute if score bool ChestMenu matches 1 run scoreboard players add numListSlots CONSTANT 1
execute if score bool ChestMenu matches 1 run scoreboard players set bool ChestMenu 0
execute store result score bool ChestMenu run data get storage minecraft:list_manual Items[23].tag.saved
execute if score bool ChestMenu matches 1 run scoreboard players add numListSlots CONSTANT 1
execute if score bool ChestMenu matches 1 run scoreboard players set bool ChestMenu 0
execute store result score bool ChestMenu run data get storage minecraft:list_manual Items[24].tag.saved
execute if score bool ChestMenu matches 1 run scoreboard players add numListSlots CONSTANT 1
execute if score bool ChestMenu matches 1 run scoreboard players set bool ChestMenu 0
execute store result score bool ChestMenu run data get storage minecraft:list_manual Items[25].tag.saved
execute if score bool ChestMenu matches 1 run scoreboard players add numListSlots CONSTANT 1
execute if score bool ChestMenu matches 1 run scoreboard players set bool ChestMenu 0

# get random number
summon area_effect_cloud 0 0 0 {Tags:["random_list_manual"],Duration:500}
execute store result score list rng run data get entity @e[type=area_effect_cloud,tag=random_list_manual,limit=1] UUID[0] 1
scoreboard players operation list rng %= numListSlots CONSTANT
scoreboard players add list rng 1
kill @e[tag=random_list_manual]
...
function end-practice:one_cycle_practice/index_list_manual
