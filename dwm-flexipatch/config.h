...
static const char *altbarcmd             = "$HOME/.config/polybar/launch.sh --hack"; /* Alternate bar launch command */
...
#if BAR_ALPHA_PATCH
static const unsigned int baralpha = 0xffffff;
...
static const Rule rules[] = {
	...
	RULE(.class = "zoom", .tags = 1 << 1)
	RULE(.class = "TLauncher", .tags = 1<< 5)
	RULE(.class = "Nautilus", .tags = 1 << 4)
	RULE(.class = "obs", .tags= 1 << 1)
	#if SCRATCHPADS_PATCH
...
static const Layout layouts[] = {
	...
	{ "[T]",      flextile,         { -1, -1, SPLIT_VERTICAL, TOP_TO_BOTTOM, TOP_TO_BOTTOM, 0, NULL } }, // default tile layout
...
static Key keys[] = {
	...
	{ ControlMask,                    0x0000ff61,    spawn,     {.v = screenshotwindow}},
	{ ShiftMask,                  0x0000ff61,    spawn,     {.v = screenshotarea}},
	{ 0,                             0x0000ff61,    spawn,       {.v = screenshotfull}},
