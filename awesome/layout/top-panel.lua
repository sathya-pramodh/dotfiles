...
local pacman_update = awful.widget.watch('bash -c ~/.config/awesome/scripts/pacman_updates', 900)
pacman_update:connect_signal("button::press", function() awful.spawn('bash -c pamac-manager') end)
